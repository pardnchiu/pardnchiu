...
### Recent
- **[Agenvoy (v0.24.7)](https://github.com/pardnchiu/Agenvoy/releases/tag/v0.24.7)** — Routes plan generation through the agent selector so a high-reasoning model writes the plan instead of the routing model. Introduces a dedicated routing prefix that pins the selector to the dense-reasoning preference chain.
