...
### Recent
- **[Agenvoy (v0.19.2)](https://github.com/pardnchiu/Agenvoy/releases/tag/v0.19.2)** — Refines external tool adapters, sandbox execution, and summary internals while documenting the native cron engine. It focuses on safer defaults, cleaner shared utilities, and better concurrent execution support for read-only integrations.
